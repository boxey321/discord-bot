/// coded by Monti, Leaked by Ampled for Cracked.to
/// Updated Leak 28/02/2021
   ...
   var roasts = roast[Math.floor(Math.random() * roast.length)];
    ...
    if(command === "commands") {
      ...
      if(command === "tools") {
        ...
        .addField('**$monti**', ' [ monti luvs u] ')
        .setColor('#080707')
        .setFooter('Bot coded by akuji. [monti] | чем тише ты, тем больше слышишь. Анекдоты, отвали.')
